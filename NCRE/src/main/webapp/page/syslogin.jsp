...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="javascript:void(0)">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<i class="icon-user"></i> <input class="m-wrap placeholder-no-fix"
							type="text" placeholder="Username" name="username" id="name" />
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<i class="icon-lock"></i> <input class="m-wrap placeholder-no-fix"
							type="password" placeholder="Password" name="password" id="pwd" />
			...
			<div class="form-actions">
				...
				<button type="submit" class="btn green pull-right" id="syslogin">
	...
	<div class="copyright">2017 &copy; NCRE. Admin Cyber Oar.</div>
	...
	<script src="js/syslogin.js" type="text/javascript"></script>
