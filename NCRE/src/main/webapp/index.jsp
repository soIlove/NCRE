				...
				<ul class="nav pull-right">
					<li class="dropdown user"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="page/login.html" id="logout"><i class="icon-key"></i> Log
									Out</a></li>
						</ul></li>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="index.jsp">主页</a>
						</ul>
					</div>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						<center><h2 style="color:#666;margin-top: 100px;">Welcome to use NCRE_STUDENT.SYSTEM</h2></center>
					</div>
				</div>
			</div>
		</div>
